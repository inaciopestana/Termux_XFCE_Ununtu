...
pd login ubuntu --shared-tmp -- env DISPLAY=:1.0 wget https://github.com/inaciopestana/Termux_XFCE_Ununtu/raw/main/mesa-vulkan-kgsl_24.1.0-devel-20240120_arm64.deb
